...
import com.myfauzan.myalarmmanager.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), View.OnClickListener, DatePickerFragment.DialogDateListener, TimePickerFragment.DialogTimeListener {
    ...
    override fun onClick(v: View) {
        when(v.id) {
            ...
            R.id.btn_set_once_alarm -> {
                ...
                alarmReceiver.setOnTimeAlarm(this, AlarmReceiver.TYPE_ONE_TIME,
                        onceDate,
                        onceTime,
                        onceMessage)
            }
    ...
    override fun onDialogTimeSet(tag: String?, hourOfDay: Int, minute: Int) {
        ...
        // Set tex dari textview berdasarkan tag
        when (tag) {
